...
const plans = [
  {
    ...
    missing: ["Anúncios automatizados", "Sistema de advertência", "Lista de presença"],
  },
  {
    id: "pro",
    name: "Pro",
          ...
          <div className="mx-auto max-w-7xl px-6">
            ...
            <div className="text-center mb-16 flex flex-col gap-4">
              ...
              <p className="text-muted-foreground max-w-lg mx-auto text-pretty">
                Preços simples e transparentes. Cancele quando quiser, sem taxas ocultas.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-7 flex flex-col gap-6 flex-1">
                    ...
                    <ul className="flex flex-col gap-3 flex-1">
                      ...
                      {plan.missing.map((f) => (
                        <li key={f} className="flex items-center gap-3 text-sm text-muted-foreground/40 line-through">
